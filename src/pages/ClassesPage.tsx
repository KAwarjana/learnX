...
import { classCardList, TABS } from "../data";
  ...
  return (
    <>
      ...
      <PageHero
        ...
        titleSizeClassName="text-[18vw] sm:text-[140px] md:text-[180px]"
      />
      ...
      <section className="w-full px-4 py-6 sm:px-6 lg:px-8">
        ...
        >
          ...
          <aside
            ref={filterRef}
            className={cn("hidden pr-2 lg:sticky lg:top-36 lg:block lg:max-h-[calc(100vh-160px)] lg:self-start lg:overflow-y-auto")}
          >
            <FilterOptions
              theme={theme}
